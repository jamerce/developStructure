 ...
 * 
 */
package org.cic.template.web.util.ajaxuploadfile;
 ...
 *
 */
public class ProgressMonitorListener implements ProgressListener {
	
	public static final String SESSION_PROGRESS_MONITOR = "progressMonitor";

    private static final Logger logger = Logger.getLogger(ProgressMonitorListener.class);
    ...
    public ProgressMonitorListener() {
	...
	public void update(long pBytesRead, long pContentLength, int pItems) {
		 ...
		 //String process = bytesRead * 1.0 / bytesLength * 100 + "";  
	     //ActionContext.getContext().getSession().put(monitorName, this.percentComplete());
	}
