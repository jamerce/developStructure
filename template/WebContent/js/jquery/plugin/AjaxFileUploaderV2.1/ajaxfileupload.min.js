...
{jQuery.handleError(s,xml,null,e);}
jQuery('#'+frameId).load(uploadCallback);return{abort:function(){}};},uploadHttpData:function(r,type){var data=!type;data=type=="xml"||data?r.responseXML:r.responseText;if(data==""){data="{'actionErrors':'read file error or file is too big!'}";}
if(type=="script")
jQuery.globalEval(data);if(type=="json"){eval("data = "+data);}
if(type=="html")
