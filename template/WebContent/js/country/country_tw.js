...
// Countries
var country_arr = new Array("阿富汗", "阿爾巴尼亞", "阿爾及利亞", "美屬薩摩亞", "安哥拉", "安圭拉", "南極洲", "安地卡及巴布達", "阿根廷", "亞美尼亞", "阿魯巴", "阿什莫爾和卡捷群島", "澳大利亞", "奧地利", "亞塞拜然", "巴哈馬", "巴林", "孟加拉", "巴貝多", "白俄羅斯", "比利時", "貝里斯", "貝南", "百慕達", "不丹", "玻利維亞", "波希尼亞及赫塞哥維那", "波札那", "巴西", "英屬維京群島", "汶萊", "保加利亞", "布吉納法索", "緬甸", "蒲隆地", "柬埔寨", "喀麥隆", "加拿大", "維德角", "開曼群島", "中非", "查德", "智利", "中華人民共和國", "聖誕島", "克利珀頓島", "可可（基林）群島", "哥倫比亞", "葛摩", "剛果民主共和國", "剛果共和國", "庫克群島", "哥斯大黎加", "象牙海岸", "克羅埃西亞", "古巴", "賽普勒斯", "捷克", "丹麥", "吉布地", "多米尼克", "多明尼加", "厄瓜多", "埃及", "薩爾瓦多", "赤道幾內亞", "厄利垂亞", "愛沙尼亞", "衣索比亞", "歐羅巴島", "福克蘭群島", "法羅群島", "斐濟", "芬蘭", "法國", "法屬蓋亞那", "法屬玻里尼西亞", "法屬南部和南極領地", "加彭", "甘比亞", "加薩走廊", "喬治亞", "德國", "迦納", "直布羅陀", "格洛里厄斯群島", "希臘", "格陵蘭", "格瑞那達", "瓜地洛普", "關島", "瓜地馬拉", "根西", "幾內亞", "幾內亞比索", "蓋亞那", "海地", "赫德島與麥當勞群島", "梵蒂岡", "宏都拉斯", "香港", "豪蘭島", "匈牙利", "冰島", "印度", "印尼", "依朗", "伊拉克", "愛爾蘭", "北愛爾蘭", "以色列", "義大利", "牙買加", "揚馬延", "日本", "賈維斯島", "澤西", "約翰斯頓環礁", "約旦", "新胡安島", "Kazakhstan", "Kenya", "Kiribati", "Korea, North", "Korea, South", "Kuwait", "Kyrgyzstan", "Laos", "Latvia", "Lebanon", "Lesotho", "Liberia", "Libya", "Liechtenstein", "Lithuania", "Luxembourg", "Macau", "Macedonia, Former Yugoslav Republic of", "Madagascar", "Malawi", "Malaysia", "Maldives", "Mali", "Malta", "Man, Isle of", "Marshall Islands", "Martinique", "Mauritania", "Mauritius", "Mayotte", "Mexico", "Micronesia, Federated States of", "Midway Islands", "Moldova", "Monaco", "Mongolia", "Montserrat", "Morocco", "Mozambique", "Namibia", "Nauru", "Nepal", "Netherlands", "Netherlands Antilles", "New Caledonia", "New Zealand", "Nicaragua", "Niger", "Nigeria", "Niue", "Norfolk Island", "Northern Mariana Islands", "Norway", "Oman", "Pakistan", "Palau", "Panama", "Papua New Guinea", "Paraguay", "Peru", "Philippines", "Pitcaim Islands", "Poland", "Portugal", "Puerto Rico", "Qatar", "Reunion", "Romainia", "Russia", "Rwanda", "Saint Helena", "Saint Kitts and Nevis", "Saint Lucia", "Saint Pierre and Miquelon", "Saint Vincent and the Grenadines", "Samoa", "San Marino", "Sao Tome and Principe", "Saudi Arabia", "Scotland", "Senegal", "Seychelles", "Sierra Leone", "Singapore", "Slovakia", "Slovenia", "Solomon Islands", "Somalia", "South Africa", "South Georgia and South Sandwich Islands", "Spain", "Spratly Islands", "Sri Lanka", "Sudan", "Suriname", "Svalbard", "Swaziland", "Sweden", "Switzerland", "Syria", "Taiwan", "Tajikistan", "Tanzania", "Thailand", "Tobago", "Toga", "Tokelau", "Tonga", "Trinidad", "Tunisia", "Turkey", "Turkmenistan", "Tuvalu", "Uganda", "Ukraine", "United Arab Emirates", "United Kingdom", "Uruguay", "USA", "Uzbekistan", "Vanuatu", "Venezuela", "Vietnam", "Virgin Islands", "Wales", "Wallis and Futuna", "West Bank", "Western Sahara", "Yemen", "Yugoslavia", "Zambia", "Zimbabwe");
...
s_a[221]="彰化|基隆|嘉義|Chung-hsing-hsin-ts'un|Hsin-chu|Hsin-chu|Hua-lien|I-lan|Kao-hsiung|Kao-hsiung|Miao-li|Nan-t'ou|P'eng-hu|P'ing-tung|T'ai-chung|T'ai-chung|T'ai-nan|T'ai-nan|T'ai-pei|T'ai-pei|T'ai-tung|T'ao-yuan|Yun-lin";
...
function populateStates( countryElementId, stateElementId ){
	...
	stateElement.options[0] = new Option('請選擇','');
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option('請選擇','-1');
